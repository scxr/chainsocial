...
describe("ChainSocial contract CommentAdded event tests", () => {
  ...
  it("ChainSocial_CommentAdded is created correctly", async () => {
    ...
    const expectedChainSocialCommentAdded: ChainSocial_CommentAdded = {
    ...
    assert.deepEqual(actualChainSocialCommentAdded, expectedChainSocialCommentAdded, "Actual ChainSocialCommentAdded should be the same as the expectedChainSocialCommentAdded");
  });
});
