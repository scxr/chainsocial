...
export async function POST(
  ...
  try {
    ...
    let response = await fetch(`https://xpheresocial-production.up.railway.app/chain-social/simulate/follow-user/${address}`, {
      method: 'GET',
    })
...
export async function GET(
  ...
  try {
    ...
    let response = await fetch(`https://xpheresocial-production.up.railway.app/data/following/${followerAddress}`, {
      method: 'GET',
    })
